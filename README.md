...
[x] João Papo-de-Pescador, homem de bem, comprou um microcomputador para
...
[x] Faça um Programa que pergunte quanto você ganha por hora e o número de horas trabalhadas no mês. Calcule e mostre o total do seu salário no referido mês, sabendo-se que são descontados 11% para o Imposto de Renda, 8%
...
[x] Faça um programa para uma loja de tintas. O programa deverá pedir o tamanho
...
[x] Faça um programa que peça o tamanho de um arquivo para download (em MB) e a
